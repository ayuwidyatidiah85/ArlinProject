...
public class activity_MonitorBeban1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitorbeban1);
        ...
        data.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                // button pemborosan
                btn_pemborosan.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        String dataNow = "data2" ;
                        Intent pemborosan_bar = new Intent(getApplicationContext(), activity_MonitorBeban2.class);
                        pemborosan_bar.putExtra("hargaNow",hargaNow) ;
                        pemborosan_bar.putExtra("bebanNow",bebanNow) ;
                        pemborosan_bar.putExtra("userNow", userNow);
        ...
        AlertDialog myQuittingDialogBox = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("reset", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Toast.makeText(activity_MonitorBeban1.this, "Data has been reset", Toast.LENGTH_LONG).show();
                        dialog.dismiss();
                    }
